//
//  ArgumentClosureCaptorTests+TwoArgs.swift
//  InstantMock
//
...
final class ArgumentClosureCaptorTests_TwoArgs: XCTestCase {
    ...
    private var captor: ArgumentClosureCaptor<(Int, Int) -> String>!


    override func setUp() {
        super.setUp()
        self.storageMock = ArgumentStorageMock()
        self.factoryMock = ArgumentFactoryMock<(Int, Int) -> String>()
        self.captor = ArgumentClosureCaptor<(Int, Int) -> String>()
    }


    func testCapture() {
        let val = captor.capture(argFactory: self.factoryMock, argStorage: self.storageMock) as (Int, Int) -> String
        ...
        _ = captor.capture(argFactory: self.factoryMock, argStorage: self.storageMock) as (Int, Int) -> String
    ...
    func testValue() {
        ...
        let closure: (Int, Int) -> String = { _, _ in return "SomeValue" }
