...
final class ArgumentClosureCaptorTests_FourArgs: XCTestCase {

    private var storageMock: ArgumentStorageMock!
    private var factoryMock: ArgumentFactoryMock<(Int, Int, Int, Int) -> String>!
    private var captor: ArgumentClosureCaptor<(Int, Int, Int, Int) -> String>!


    override func setUp() {
        super.setUp()
        self.storageMock = ArgumentStorageMock()
        self.factoryMock = ArgumentFactoryMock<(Int, Int, Int, Int) -> String>()
        self.captor = ArgumentClosureCaptor<(Int, Int, Int, Int) -> String>()
    }


    func testCapture() {
        let val = captor.capture(argFactory: self.factoryMock, argStorage: self.storageMock)
            as (Int, Int, Int, Int) -> String
    ...
    func testValue() {
        ...
        let closure: (Int, Int, Int, Int) -> String = { _, _, _, _ in return "SomeValue" }
    ...
    func testAllValues() {
        ...
        let ret = values.first!!(12, 13, 14, 15)
        XCTAssertEqual(ret, "SomeValue")
    }
