...
final class ArgumentClosureCaptorTests_ThreeArgs: XCTestCase {

    private var storageMock: ArgumentStorageMock!
    private var factoryMock: ArgumentFactoryMock<(Int, Int, Int) -> String>!
    private var captor: ArgumentClosureCaptor<(Int, Int, Int) -> String>!


    override func setUp() {
        super.setUp()
        self.storageMock = ArgumentStorageMock()
        self.factoryMock = ArgumentFactoryMock<(Int, Int, Int) -> String>()
        self.captor = ArgumentClosureCaptor<(Int, Int, Int) -> String>()
    }
    ...
    func testValue() {
        ...
        let closure: (Int, Int, Int) -> String = { _, _, _ in return "SomeValue" }
        ...
        let ret = value!(12, 13, 14)
        XCTAssertEqual(ret, "SomeValue")
    }


    func testAllValues() {
        _ = captor.capture(argFactory: self.factoryMock, argStorage: self.storageMock) as (Int, Int, Int) -> String
